...
- **Replace `8.1` with the PHP version you installed, e.g. if you're using Raspbian Stretch (Debian 9) replace `8.1` with `7.0`.**
- The `php8.1-sqlite3` package must be installed otherwise Networking and Querying will throw an error that it can't access the database.
...
2. Install necessary packages
    ...
    ```bash
    apt-get -y install nginx php8.1-fpm php8.1-cgi php8.1-xml php8.1-sqlite3 php8.1-intl apache2-utils
    ```
...
4. Enable php8.1-fpm at startup
